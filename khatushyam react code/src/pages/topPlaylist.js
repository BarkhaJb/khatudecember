...
const TopPlaylist = ({
  ...
  useEffect(() => {
    ...
    const url = (`${process.env.REACT_APP_BASE_URL}/playlist/songs/${currentArtist?._id}`);
    fetch(url)
  ...
  return (
    <div className="trend">
       <Helmet>
        ...
        <link rel="canonical" href="https://khatuwaleshyam.com/TopPlaylist" />
      </Helmet>
      <div className="trend-area">
        <div className="routes">
          <h6 className="rts-rts">
            ...
            -- <Link className="rts-rts">Top Playlist</Link>--{" "}
