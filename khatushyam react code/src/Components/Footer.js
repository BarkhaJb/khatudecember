...
const Footer = ({
  ...
  const navigateliveInsta = () => {
    window.open("https://www.instagram.com/khatuwaleshyam.108/");
  };

  const navigateliveFacebook = () => {
    window.open("https://www.facebook.com/profile.php?id=100083786253213");
  };

  const navigateliveYoutube = () => {
    window.open("https://www.youtube.com/@khatuwaleshyam108");
  };

  const navigatelivetwitter = () => {
    ...
    <div className="footer">
      <div className="container-fluid first-foo-para">
        <div className="top-footer-para">
          <h2>Sunne Wala Shyam Sunane wala Shyam</h2>
          <div className="para">
            <p>
              Kathin rah bhi saral ho jayegi mushkilen sari hal ho jayegi ek bar
              aaja tu sharan shyam ke zindagi teri safal ho jayegi, Jay shree
              Shyam.
            </p>
          </div>
        </div>
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="footer-awsfnts">
            ...
            <div className="footer-awsfnts-area">
              <Link to="" className="anchor-foo">
                <button
                  className="foot-btn-icon face"
                  onClick={navigateliveFacebook}
                >
                  {" "}
              ...
              <Link to="" className="anchor-foo">
                <button
                  className="foot-btn-icon insta"
                  onClick={navigateliveInsta}
                >
              ...
              <Link to="" className="anchor-foo">
                <button
                  className="foot-btn-icon twitter"
                  onClick={navigatelivetwitter}
                >
              ...
              <Link to="" className="anchor-foo">
                {" "}
                <button
                  className="foot-btn-icon youtube"
                  onClick={navigateliveYoutube}
                >
          ...
          <div className="footer-para">
            <ul className="about-para">
              <li className="about-para2 right-border">
                Advertise on Khatuwaleshyam.com{" "}
              </li>
                  ...
                  <div className="album-area">
                    ...
                    <div className="menu1-content">
                      <ul className="album-list">
                        {category.map((user) => (
                          <li
                            className="album-item bullet anchor-foo"
                    ...
                    <div className="menu2-content">
                      <ul className="genres-list">
                        {playlist.slice(0, 5).map((user) => (
                          <li
                            className="genres-item bullet anchor-foo"
                  ...
                  <div className="menu3-content">
                    <ul className="artist-list">
                      {artist.slice(0, 5).map((user) => (
                        <li
                          className="artist-item bullet anchor-foo"
                          onClick={() => navigateToTopArtist(user)}
                        >
                          {user.artist}{" "}
                        </li>
                      ))}
                  ...
                  <div className="menu4-content">
                    <ul className="release-list">
                      {artist.slice(-5).map((song) => (
                        <li
                          className="artist-item bullet anchor-foo"
                          onClick={() => navigateToTopArtist(song)}
                        >
                          {song.artist}
                        </li>
                      ))}
        ...
        <div className="bottom-footer">
          <p className="bottom-footer-para" onClick={navigateTojmbliss}>
            {" "}
            © 2022 Jmbliss IT Solutions
          </p>
        </div>
      </div>
    </div>
